...
\section{Experience}
  \noindent\textbf{GenAI Developer} \hfill \textit{December 2024 - Present}\\
    ...
    \begin{itemize}[label=$\circ$]
        \item Developing AI agents, creating GenAI proof-of-concepts (POCs), and identifying and implementing GenAI use cases to drive innovation and enhance business solutions.
      \end{itemize}
...
\vspace{1pt}
\section{Skills}
	{Python, C, C++, SQL, Algorithms, Data Science, EDA, Machine Learning, Deep Learning, Generative AI, NLP, LLM, RAG, AI Agents, Vector DB, XGBoost, Computer Vision, MLOps, TensorFlow, Keras, Scikit-Learn, Numpy, Pandas, Matplotlib, AWS, GCP, Azure, GitHub, Kubernetes, CI/CD, Information Retrieval}
