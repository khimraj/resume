...
%-----------EXPERIENCE-----------------
\section{Experience}
  \noindent\textbf{GenAI Developer} \hfill \textit{December 2024 - Present}\\
    Docusign \hfill Bengaluru, India
    \vspace{-2pt}
    \begin{itemize}[label=$\circ$]
        \item Designed and deployed AI agent-based solutions for intelligent information retrieval and personalized email generation (first-touch and follow-up), increasing click-through rates by 14\% across multiple use cases. 
        \vspace{-4pt}
        \item Built a robust Text-to-SQL pipeline leveraging LangChain and vector databases, enabling natural language queries over structured datasets and streamlining data accessibility.
        \vspace{-4pt}
        \item Integrated GenAI capabilities into production systems, including RAG pipelines, MCP Server, LLM routing, and GenAI-specific observability, enhancing system performance and monitoring.
      \end{itemize}
...
\vspace{1pt}
\section{Skills}
	{Python, C, C++, SQL, NumPy, Pandas, Matplotlib, Scikit-Learn, TensorFlow, Keras, XGBoost, Algorithms, Data Science, EDA, Machine Learning, Deep Learning, Computer Vision, Generative AI, NLP, LLM, RAG, AI Agents, MCP, Information Retrieval, LangChain, LangGraph, CrewAI, Vector DB, MLOps, Airflow, Arize, GitHub, CI/CD, Kubernetes, AWS, GCP, Azure}
